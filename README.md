...
Additional scripts that may be useful include `evaluate.py` (which allows you to evaluate against gold scores) and `gather_top_replacements.py` (which gathers the top replacement terms from each corpus).
